      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto items-center">
          ...
          >
            <div className="bg-white rounded-2xl border border-border p-8 shadow-lg">
              <div className="aspect-square rounded-xl overflow-hidden mb-6">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1658297063569-162817482fb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzaG9wcGluZyUyMG9ubGluZSUyMGVjb21tZXJjZXxlbnwxfHx8fDE3NjI4NjIyMzR8MA&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Shopping"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="text-center">
                <h2 className="mb-2">Welcome to Samuel Adikah Store</h2>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
          >
            <Card className="bg-white border-border shadow-lg p-8">
              <div className="mb-8">
                <h1 className="mb-2">
